/* 
    Aqui vamos a estar definiendo la tabla de Carreras y PlanesEstudio es una propiedad de navegacion
    que establese una relacion de 1:N (Osea de uno a muchos)
*/
...
namespace Entidades.Modelos.PlanesDeEstudio.Carreras
{
    public class E_Carrera
    {
        ...
        // Navegación (plural)
        public ICollection<Entidades.Modelos.PlanEstudios.E_PlanEstudio> PlanesEstudio { get; set; } = new List<Entidades.Modelos.PlanEstudios.E_PlanEstudio>();
    }
}
